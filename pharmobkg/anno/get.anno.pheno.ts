...
const outputFile = "./pharmobkg/anno/nodes.annotations.pheno.csv";

const edgesVariFile = "./pharmobkg/anno/edges.anno.pheno.variants.csv";
const edgesHaploFile = "./pharmobkg/anno/edges.anno.pheno.haplo.csv";
const edgesGeneFile = "./pharmobkg/anno/edges.anno.pheno.genes.csv";
const edgesDrugsFile = "./pharmobkg/anno/edges.anno.pheno.drugs.csv";
// const edgesPhenoFile = "./pharmobkg/anno/edges.anno.pheno.pheno.csv";
