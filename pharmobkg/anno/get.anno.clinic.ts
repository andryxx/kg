...
const outputFile = "./pharmobkg/anno/nodes.annotations.clinic.csv";

const edgesVariFile = "./pharmobkg/anno/edges.anno.clinic.variants.csv";
const edgesHaploFile = "./pharmobkg/anno/edges.anno.clinic.haplo.csv";
const edgesGeneFile = "./pharmobkg/anno/edges.anno.clinic.genes.csv";
const edgesDrugsFile = "./pharmobkg/anno/edges.anno.clinic.drugs.csv";
const edgesPhenoFile = "./pharmobkg/anno/edges.anno.clinic.pheno.csv";
...
const header = [
    ...
    "level_of_evidence:String(single)",
    "level_modifiers:String(single)",
    "score:String(single)",
    "type:String(single)",
    "pmid_count:String(single)",
    "evidence_count:String(single)",
];
    ...
    for (const sourceFile of sourceFiles) {
        ...
        for (const dataRow of dataSet) {
            const {
                ...
                "Level of Evidence": lvlEvidence,
                "Level Modifiers": lvlModifiers,
                "Score": score,
                "Phenotype Category": type,
                "PMID Count": pmidCount,
            ...
            await annoCsv.write([
                annoNodeId, // "~id", // ?	~id
                "annotation;clinical_annotation", // "~label", // ?	~label  // human_disease
                // tty, // "node_tty:String",
                // ttyText, // "node_tty_text:String",
                pgkbId, // "node_code:String",
                `Clinical Annotation ${pgkbId}`, // `"node_name:String"`,
                source, // "node_source_1:String",
                // // ?	node_source_2:String
                "atom", // "type:String", // ?	
                uploadDate, // "uploaded_at:Date", // "YYYY-MM-DD"
                lvlEvidence, // "level_of_evidence:String(single)",
                lvlModifiers, // "level_modifiers:String(single)",
                score, // "score:String(single)",
                type, // "type:String(single)",
                pmidCount, // "pmid_count:String(single)",
                evidenceCount, // "evidence_count:String(single)",
            ]);
