...
const variFile = "./pharmobkg/variants/nodes.variants.csv";
const snpFile = "./pharmobkg/variants/nodes.snp.csv";

const missedVariFile = "./pharmobkg/variants/dont.load.missed.variants.csv";

const edgesFileSnp = "./pharmobkg/variants/edges.vari.snp.csv";
const edgesFileGene = "./pharmobkg/variants/edges.vari.gene.csv";

const uploadDate = "2023-12-05T09:04:40.920Z";

const checkListFile = "./pharmobkg/anno/dont.load.list.variants.csv";
const genesFile = "./pharmobkg/genes/nodes_genes.csv";
...
(async () => {
    ...
    // STAGE 1
    // Check if the source file contains the complete list of variants
