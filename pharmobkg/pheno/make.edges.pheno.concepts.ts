...
const mappingFile = "./pharmobkg/pheno/pheno.mapping.csv";
const edgesCsvFile = "./pharmobkg/pheno/edges.pheno.concepts.csv";
const uploadDate = "2023-09-02T09:04:40.920Z";
const prefix = "pgkb";
const source = "pgkb";
